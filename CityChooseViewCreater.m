...
@implementation CityChooseViewCreater
...
-(void)show:(UIView*)view{
    ...
    // 点击的时候传三个index进去
    self.picker = [[ActionSheetCustomPicker alloc]initWithTitle:@"选择地区" delegate:self showCancelButton:YES origin:view initialSelections:@[@(self.index1),@(self.index2),@(self.index3)]];
